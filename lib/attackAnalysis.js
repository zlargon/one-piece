...
export default function attackAnalysis({ enemy, boat, characters }) {
  ...
  characters.forEach(function(character) {
    ...
    switch (character.timing) {
        case 'bad':     chainMagnification =  1;    break;
        case 'good':    chainMagnification += 0;    break;
        case 'great':   chainMagnification += 0.1;  break;
        case 'perfect': chainMagnification += 0.3;  break;
        case 'miss':    chainMagnification =  1;    break;
    }

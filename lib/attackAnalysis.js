...
function attackAnalysis(param) {
    ...
    if (1 > captainList.length || captainList.length > 2) {
        log(`captain number is wrong: ${captainList.length}`);
        return null;
    }
    ...
    captainList.forEach(function (captain, n) {
        ...
        var content = captain.captain.tw.content || captain.captain.jp.content;
    ...
    attackList.forEach(function(member, n) {
        ...
        captainList.forEach(function(captain) {
            var fn = captain.captain.magnification;
